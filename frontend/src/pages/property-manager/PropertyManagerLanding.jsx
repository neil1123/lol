...
const PropertyManagerLanding = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <span className="text-gray-600 ml-2 hidden sm:inline">for Property Managers</span>
            </div>
            ...
            <div className="md:hidden border-t bg-white py-4">
              <div className="flex flex-col space-y-3">
                <button
                  ...
                  className="text-left px-4 py-2 text-blue-600 hover:text-blue-800 font-medium"
                >
                  Sign In
                </button>
                <button
                  ...
                  className="text-left px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors mx-4"
                >
                  Get Started
                </button>
              </div>
      ...
      {/* Hero Section */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 sm:pt-20 pb-16">
        <div className="text-center">
          ...
          <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8 px-4">
            <button
              onClick={() => navigate('/property-manager/auth')}
      ...
      <div className="py-12 sm:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-600 px-4">
      ...
      <div className="bg-blue-600">
        <div className="max-w-7xl mx-auto text-center py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          ...
          <p className="mt-4 text-lg text-blue-100 px-4">
      ...
      <footer className="bg-gray-800">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-8 text-gray-300">
              <button
                onClick={() => navigate('/')}
