...
BACKEND_URL = "https://b20dd39b-910e-4cb5-9a88-731af3f6b819.preview.emergentagent.com/api"
...
def test_provider_login():
    ...
    print("\n🔍 Testing Provider Login with Existing Credentials...")
    global provider_token, provider_id
    
    try:
        # Use existing provider credentials as mentioned in review request
        login_data = {
...
def test_homeowner_login():
    """Test homeowner login for authorization testing"""
    print("\n🔍 Testing Homeowner Login...")
    global homeowner_token, homeowner_id
    
    try:
        # Use existing homeowner credentials
        login_data = {
...
def run_provider_profile_tests():
    ...
    # Test 3: Homeowner Login (for authorization testing)
